...
``` {r fb-ctr-import}
fb_keys <- "EAACEdEose0cBABOisrwSSyf11fNXupmcrwjvhcWPv6ZCTnlCZBBydwgEAu5RVQSO1oHDPIxgiKnBBJF5xS6cKS5O1RfzSHZCa2bKrdtIusNvIUfVYfQiPdGQEeXedVKEdz1rfaKjZC7izyYFZAaKord7UUL6hyFpIspzBBKUGz1oGUXyv4SkVgTRPZBrnrNI4ZD"
...
ggplot(data=ctr_m_df %>% mutate(fb_ym = ymd(paste0("19", fb_ym,"-01")))) +
