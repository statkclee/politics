...
``` {r idbr-population-pyramid-data, message=FALSE}
library(tidyverse)
...
```
<img src="fig/korea_pyramid" alt="인구 피라미드 변화 1990 - 2050" />
...
``` {r idbr-population-pyramid-election, message=FALSE}
library(gridExtra)
