...
``` {r korea-speech-common-wordcloud}
## 4.3. 공통 단어구름
...
commonality.cloud(mb_gh_m, max.words=20, scale=c(4,.5),  rot.per = 0.1, family="NanumGothic", colors=pal)
```
...
``` {r korea-speech-comparison-wordcloud}
## 4.3. 비교 단어구름
