...
plt <- gvisTimeline(data=election.dat,
                    ...
                    start="start", end="end",
                    options=list(width="1024px", height="500px", timeline="{showRowLabels:true}"))
...
timelineS(pe_event,  buffer.days = 10, main="박근혜 대통령 탄핵 전후 주요 사건", label.direction = "up", label.length = c(0.2,0.8,0.4,1.2), label.position = 3,
